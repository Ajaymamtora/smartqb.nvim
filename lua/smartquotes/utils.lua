...
---@param col number The current column (0-indexed)
---@param quote_char string The quote character to count
---@return number The count of unescaped quotes
...
---@param line string The current line
---@param col number The current column (0-indexed)
---@param quote_chars table A table of valid quote characters
---@return number|nil, string|nil The position and character of the next unescaped quote, or nil if not found
...
---@param direction number The direction to search (1 for forward, -1 for backward)
